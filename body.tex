...
\begin{itemize}
	...
	\item Bestimmen und diskutieren Sie die Abweichung zwischen den tabellierten und gemessenen Doppler-freien Linienposition.
%	\item Bestimmen Sie den Dipol- und den Quadrupol-Term der Hyperfeinstrukturkonstanten (inkl. Messunsicherheit).
	...
	\item Bestimmen Sie die Temperaturabhängigkeit der Teilchenzahldichte und vergleichen Sie diese mit Ihren Erwartungen.
...
\begin{questions}
	\myitem{Zeichnen Sie ein Diagramm, das die energetische Lage der relevanten Zustände und die erlaubten Übergänge skizziert. Geben Sie dabei sowohl die spektroskopische Bezeichnung als auch die Quantenzahlen an. Beschriften Sie die Linien in Abbildung \label{sim_spectra_null}.}
	\myitem{Schrieben Sie ein Skript in einer Programmiersprache Ihrer Wahl, das die im Experiment erwarteten Linien-Positionen und Linien-Abstände berechnet. Zur Kontrolle: der kleinste Abstand sollte 29.4~MHz betragen (ohne die unten eingeführten cross-over-peaks).  \label{frage:peaks}}
\end{questions}
