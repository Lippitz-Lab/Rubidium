...
\begin{questions}
	\myitem{Die grauen Linien in Abbildung \label{fig:balanced} befinden sich bei den relativen Frequenzen -106, -74, -42, -14, +18 und +78~MHz. Um welche Übergänge handelt es sich? }

	\myitem{Die Maxima der schwarzen Kurve in Abbildung \label{fig:balanced}  befinden sich bei den relativen Frequenzen -103, -73, -42, -15, +17 und +80~MHz.	Durch welche Werte der Dipol- und Quadrupol-Hyperfeinstrukturkonstanten  $A_{HFS}$ und $B_{HFS}$ werden diese Linien am besten beschrieben? Passen Sie dazu Ihr Skript aus Frage \label{frage:peaks} an, um eine Veränderung der tabellierten Konstanten zu ermöglichen. Optimieren Sie diese (siehe Anhang) um die Daten optimal zu beschrieben. }
\end{questions}
