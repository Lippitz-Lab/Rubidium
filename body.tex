...
\begin{questions}
	...
	\myitem{Schreiben Sie ein Skript in einer Programmiersprache Ihrer Wahl, das die im Experiment erwarteten Positionen und Abstände der Linien berechnet. Zur Kontrolle: Die größte Frequenz sollte 6.991~GHz und der Mittelwert aller Linien 3.229~GHz betragen (ohne die unten eingeführten Cross-Over-Peaks). \label{frage:peaks}}
\end{questions}
