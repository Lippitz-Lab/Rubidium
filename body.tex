...
\begin{questions}
	\myitem{Berechnen Sie das erwartete Doppler-verbreiterte Spektrum von Rubidium in der natürlichen Isotopenmischung.
...
\begin{questions}
	\myitem{Bei sehr niedriger Laserleistung werden im Peak 95\% des Lichts in der Gaszelle absorbiert. Berechnen Sie via Gl.~\ref{eq:lambert_beer} die Form des Doppler-verbreiterten Absorptionspektrums und vergleichen Sie mit Ihrem Ergebnis von Frage \ref{FzV:doppler_theo}.}
\end{questions}
