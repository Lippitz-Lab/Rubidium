...
\begin{questions}
	\myitem{Die Maxima der schwarzen Kurve in Abbildung \ref{fig:balanced}  befinden sich bei den relativen Frequenzen -103, -73, -42, -15, +17 und +80~MHz. Um welche Übergänge handelt es sich? }
...
%	\item Bestimmen Sie den Dipol- und den Quadrupol-Term der Hyperfeinstrukturkonstanten (inkl. Messunsicherheit).
	\item Messen Sie das Doppler-verbreiterte Absorptionsspektrum bei verschiedenen Temperaturen.
	\item Bestimmen Sie die Temperaturabhängigkeit der Dopplerverbreiterung und vergleichen Sie diese mit Ihren Erwartungen.
	\item Bestimmen Sie die Temperaturabhängigkeit der Teilchenzahldichte und vergleichen Sie diese mit Ihren Erwartungen. \\[1em]
