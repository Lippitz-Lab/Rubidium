...
% make Measurements
\node [block, minimum width=3cm] (meas_app) {realisiertes \\ Messsystem};
\node [block, minimum width=3cm] (phys_app) [right=17mm of meas_app] {realisiertes \\ physikalisches System};
...
% Enact Revisions
\node [block, minimum width=3.4cm] (revise1) [below=17mm of propose, xshift=-5.7cm] {Modell des\\  Messsystems\\ verbessern};
\node [block, minimum width=3.4cm] (revise2) [below=17mm of propose, xshift=-1.9cm] {Messsystem\\  verbessern};
